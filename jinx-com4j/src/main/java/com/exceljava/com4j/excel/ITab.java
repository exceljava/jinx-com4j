...
public interface ITab extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type com.exceljava.com4j.excel.XlThemeColor
   */

  @VTID(14)
  com.exceljava.com4j.excel.XlThemeColor getThemeColor();
   ...
   * </p>
   * @param rhs Mandatory com.exceljava.com4j.excel.XlThemeColor parameter.
   */

  @VTID(15)
  void setThemeColor(
    com.exceljava.com4j.excel.XlThemeColor rhs);
