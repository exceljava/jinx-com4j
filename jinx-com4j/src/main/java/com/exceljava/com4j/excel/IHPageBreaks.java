...
public interface IHPageBreaks extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type com.exceljava.com4j.excel.HPageBreak
   */

  @VTID(11)
  com.exceljava.com4j.excel.HPageBreak getItem(
    int index);
  ...
  @VTID(12)
  @DefaultMethod
  com.exceljava.com4j.excel.HPageBreak get_Default(
    int index);
  ...
  @VTID(14)
  com.exceljava.com4j.excel.HPageBreak add(
