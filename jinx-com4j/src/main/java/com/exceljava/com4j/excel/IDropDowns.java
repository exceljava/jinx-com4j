...
public interface IDropDowns extends Com4jObject,Iterable<Com4jObject> {
   ...
   * </p>
   * <ul>
     * <li>java.lang.Object parameter editable is set to com4j.Variant.getMissing()</li></ul>
   * <p>
   * Therefore, using this method is equivalent to
   * <code>
   ...
   * @return  Returns a value of type com.exceljava.com4j.excel.DropDown
   */
  ...
  @ReturnValue(index=5)
  com.exceljava.com4j.excel.DropDown add(
    double left,
    double top,
    double width,
    double height);
