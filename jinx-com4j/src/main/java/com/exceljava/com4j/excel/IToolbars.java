...
public interface IToolbars extends Com4jObject,Iterable<Com4jObject> {
   ...
   * </code>
   * </p>
   * @return  Returns a value of type com.exceljava.com4j.excel.Toolbar
   */
  ...
  @ReturnValue(index=1)
  com.exceljava.com4j.excel.Toolbar add();
  ...
  @VTID(12)
  @DefaultMethod
  com.exceljava.com4j.excel.Toolbar get_Default(
  ...
  @VTID(13)
  com.exceljava.com4j.excel.Toolbar getItem(
    @MarshalAs(NativeType.VARIANT) java.lang.Object index);
