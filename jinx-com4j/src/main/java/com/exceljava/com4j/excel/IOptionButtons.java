...
public interface IOptionButtons extends Com4jObject,Iterable<Com4jObject> {
   ...
   * </p>
   * @return  Returns a value of type com.exceljava.com4j.excel.GroupBox
   */

  @VTID(66)
  com.exceljava.com4j.excel.GroupBox getGroupBox();
   ...
   * @return  Returns a value of type com.exceljava.com4j.excel.OptionButton
   */

  @VTID(67)
  com.exceljava.com4j.excel.OptionButton add(
    double left,
    double top,
    double width,
    double height);
