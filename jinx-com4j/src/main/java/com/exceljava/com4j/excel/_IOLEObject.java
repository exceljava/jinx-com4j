...
public interface _IOLEObject extends Com4jObject {
  ...
  @VTID(59)
  @UseDefaultValues(paramIndexMapping = {1}, optParamIndex = {0}, javaType = {com.exceljava.com4j.excel.XlOLEVerb.class}, nativeType = {NativeType.Int32}, variantType = {Variant.Type.VT_I4}, literal = {"1"})
  @ReturnValue(type=NativeType.VARIANT,index=1)
