...
public interface CalculatedFields extends Com4jObject,Iterable<Com4jObject> {
  ...
  @DISPID(2085)
  com.exceljava.com4j.excel.PivotField _Add(
  ...
  @DISPID(170)
  com.exceljava.com4j.excel.PivotField item(
  ...
  @PropGet
  @DefaultMethod
  com.exceljava.com4j.excel.PivotField get_Default(
  ...
  @ReturnValue(index=-1)
  com.exceljava.com4j.excel.PivotField add(
    java.lang.String name,
    java.lang.String formula);
