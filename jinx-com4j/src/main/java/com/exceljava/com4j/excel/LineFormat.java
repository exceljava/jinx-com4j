...
public interface LineFormat extends com.exceljava.com4j.office._IMsoDispObj {
  ...
  @VTID(10)
  com.exceljava.com4j.excel.ColorFormat getBackColor();
   ...
   * </p>
   * @param backColor Mandatory com.exceljava.com4j.excel.ColorFormat parameter.
   */

  @DISPID(100) //= 0x64. The runtime will prefer the VTID if present
  @VTID(11)
  void setBackColor(
    com.exceljava.com4j.excel.ColorFormat backColor);
  ...
  @VTID(26)
  com.exceljava.com4j.excel.ColorFormat getForeColor();
   ...
   * </p>
   * @param foreColor Mandatory com.exceljava.com4j.excel.ColorFormat parameter.
   */

  @DISPID(108) //= 0x6c. The runtime will prefer the VTID if present
  @VTID(27)
  void setForeColor(
    com.exceljava.com4j.excel.ColorFormat foreColor);
