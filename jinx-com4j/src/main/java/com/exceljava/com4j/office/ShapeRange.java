...
public interface ShapeRange extends com.exceljava.com4j.office._IMsoDispObj,Iterable<Com4jObject> {
  // Methods:
  /**
   * <p>
  ...
  @VTID(17)
  com.exceljava.com4j.office.ShapeRange duplicate();
  ...
  @VTID(22)
  com.exceljava.com4j.office.Shape group();
  ...
  @VTID(24)
  com.exceljava.com4j.office.Shape regroup();
   ...
   * </p>
   * <ul>
     * <li>com.exceljava.com4j.office.Shape parameter primaryShape is set to 0</li></ul>
   * <p>
   * Therefore, using this method is equivalent to
   * <code>
   * mergeShapes(mergeCmd, 0);
   * </code>
   * </p>
   * @param mergeCmd Mandatory com.exceljava.com4j.office.MsoMergeCmd parameter.
   */

  @DISPID(156) //= 0x9c. The runtime will prefer the VTID if present
  @VTID(101)
  @UseDefaultValues(paramIndexMapping = {0}, optParamIndex = {1}, javaType = {com.exceljava.com4j.office.Shape.class}, nativeType = {NativeType.ComObject}, variantType = {Variant.Type.VT_I2}, literal = {"0"})
  void mergeShapes(
    com.exceljava.com4j.office.MsoMergeCmd mergeCmd);
  ...
  void mergeShapes(
    com.exceljava.com4j.office.MsoMergeCmd mergeCmd,
    @Optional @DefaultValue("0") com.exceljava.com4j.office.Shape primaryShape);
